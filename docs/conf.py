...
# pixels large.
html_favicon = '_static/neurotic-logo.ico'


# -- Options for HTMLHelp output ---------------------------------------------

# Output file base name for HTML help builder.
htmlhelp_basename = 'neuroticdoc'
...
man_pages = [
    (master_doc, 'neurotic', 'neurotic Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'neurotic', 'neurotic Documentation',
     author, 'neurotic', 'One line description of project.',
     'Miscellaneous'),
]
